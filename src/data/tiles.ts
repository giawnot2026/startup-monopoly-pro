...
export const TILES: Tile[] = [
  { id: 0, name: "START: Fiscal Year", type: "funding", category: "FINANCE", revenueModifier: 0, costModifier: 0 },
  
  { id: 1, name: "Sviluppo MVP", type: "asset", category: "PRODUCT", revenueModifier: 0, costModifier: 5000, badges: createBadges(25000, 1000), 
  ...
  { id: 2, name: "Test di Mercato", type: "asset", category: "FOUNDATION", revenueModifier: 2500, costModifier: 1000, badges: createBadges(30000, 1500), 
  ...
  { id: 3, name: "Probabilità", type: "special", category: "SPECIAL", revenueModifier: 0, costModifier: 0 },
  
  { id: 4, name: "Pitch Incubatori", type: "asset", category: "FOUNDATION", revenueModifier: 3500, costModifier: 500, badges: createBadges(30000, 1500), 
  ...
  { id: 5, name: "Costi Prototipo", type: "tax", category: "PRODUCT", revenueModifier: 0, costModifier: 2500, badges: createBadges(25000, 1000),
  ...
  { id: 6, name: "Primi Clienti", type: "asset", category: "MARKET", revenueModifier: 3500, costModifier: 500, badges: createBadges(35000, 1750), 
  ...
  { id: 7, name: "Funding Round", type: "funding", category: "FINANCE", revenueModifier: 0, costModifier: 0 },
  
  { id: 8, name: "Campagna Marketing", type: "asset", category: "MARKET", revenueModifier: 7500, costModifier: 5000, badges: createBadges(35000, 1750), 
  ...
  { id: 9, name: "Espansione Canali", type: "asset", category: "EXPANSION", revenueModifier: 7500, costModifier: 2500, badges: createBadges(50000, 2500), 
  ...
  { id: 10, name: "Imprevisto", type: "special", category: "SPECIAL", revenueModifier: 0, costModifier: 0 },
  
  { id: 11, name: "Nuovi Mercati", type: "asset", category: "MARKET", revenueModifier: 10000, costModifier: 3500, badges: createBadges(35000, 1750), 
  ...
  { id: 12, name: "Partnership Strategiche", type: "asset", category: "EXPANSION", revenueModifier: 10000, costModifier: 2500, badges: createBadges(50000, 2500), 
  ...
  { id: 13, name: "Competitor Emergente", type: "tax", category: "EXPANSION", revenueModifier: -7500, costModifier: 2500, badges: createBadges(50000, 2500),
  ...
  { id: 14, name: "Funding Round", type: "funding", category: "FINANCE", revenueModifier: 0, costModifier: 0 },
  
  { id: 15, name: "Probabilità", type: "special", category: "SPECIAL", revenueModifier: 0, costModifier: 0 },
  
  { id: 16, name: "Espansione Globale", type: "asset", category: "EXPANSION", revenueModifier: 15000, costModifier: 5000, badges: createBadges(50000, 2500), 
  ...
  { id: 17, name: "Hiring Team", type: "tax", category: "FOUNDATION", revenueModifier: 0, costModifier: 7500, badges: createBadges(30000, 1500),
  ...
  { id: 18, name: "Ottimizzazione Prodotto", type: "tax", category: "PRODUCT", revenueModifier: 0, costModifier: 5000, badges: createBadges(25000, 1000), 
  ...
  { id: 19, name: "Aumento Retention", type: "asset", category: "MARKET", revenueModifier: 6500, costModifier: 1500, badges: createBadges(35000, 1750), 
  ...
  { id: 20, name: "Imprevisto", type: "special", category: "SPECIAL", revenueModifier: 0, costModifier: 0 },
  
  { id: 21, name: "Funding Round", type: "funding", category: "FINANCE", revenueModifier: 0, costModifier: 0 },
  
  { id: 22, name: "Probabilità", type: "special", category: "SPECIAL", revenueModifier: 0, costModifier: 0 },
  
  { id: 23, name: "Acquisizione Aziendale", type: "asset", category: "EXPANSION", revenueModifier: 25000, costModifier: 10000, badges: createBadges(50000, 2500), 
  ...
  { id: 24, name: "Spin-off", type: "asset", category: "FOUNDATION", revenueModifier: 7500, costModifier: 5000, badges: createBadges(30000, 1500), 
  ...
  { id: 25, name: "Licenza Brevetto", type: "asset", category: "PRODUCT", revenueModifier: 20000, costModifier: 5000, badges: createBadges(30000, 1500), 
  ...
  { id: 26, name: "Imprevisto", type: "special", category: "SPECIAL", revenueModifier: 0, costModifier: 0 },
  
  { id: 27, name: "Exit Preparation", type: "tax", category: "FINANCE", revenueModifier: 0, costModifier: 0, 
